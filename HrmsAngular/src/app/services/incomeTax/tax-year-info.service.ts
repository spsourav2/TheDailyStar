...
getAllSlabIncomeBySlabId(id:number){
  return this.http.get(environment.apiUrl+'/incometax/slabincometax/getallslabincomeById/'+id);
}

getAllSlabIncomeByTaxYearID(id:number){
  return this.http.get(environment.apiUrl+'/incometax/slabincometax/slabincomeBytaxyearid/'+id);
}
