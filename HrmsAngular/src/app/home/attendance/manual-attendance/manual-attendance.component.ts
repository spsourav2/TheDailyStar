...
getAttendenceByDDMMYY(){
  ...
  if(this.f.dDMMYYYY.value==null){
    ...
    // let obj= new ManualAttendence();
    // obj=this.manualAttForm.value;
    // obj.DDMMYYYY=this.f.DDMMYYYY.value
...
getDatetime() {
  ...
  if (!value) {
    ...
    this._value=null
  this.manualAttForm.get("punch_time").setValue(this._value);
  this.label=value;
}
...
// form = new FormGroup({
//   punch_time: new FormControl(),
//   attnDate: new FormControl(),
//   DDMMYYYY:new FormControl(),
// });
